public class ListaDinamica implements IEstruturaDinamica {
    ...
    public void removerTodasOcorrencias(Object elemento) {
        ...
        // Se nenhum elemento foi removido, podemos exibir uma mensagem, se necessário
        if (!removido) {
    ...
    public void ordenarCrescente() {
        if (estaVazia() || tamanho == 1) {
            return; // Se a lista estiver vazia ou tiver apenas um elemento, não há nada para ordenar
        }
        ...
        } while (trocado); // Continua trocando enquanto houver trocas
    }
    ...
    public void editarElemento(Object elementoAntigo, Object elementoNovo) {
        ...
        while (atual != null) {
            if (atual.getConteudo().equals(elementoAntigo)) {
                atual.setConteudo(elementoNovo); // Altera o conteúdo do nó
                return; // Sai assim que o elemento for encontrado e alterado
            }
            atual = atual.getProx();
        }
    ...
    public void limpar() {
        primeiro = null;  // O primeiro nó é agora null, indicando que a lista está vazia
        ultimo = null;    // O último nó também é null
        tamanho = 0;      // Zera o contador de tamanho
    }
